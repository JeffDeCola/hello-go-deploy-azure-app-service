#!/bin/sh
# hello-go-deploy-azure-app-service build-push.sh
...
echo "cp -r hello-go-deploy-azure-app-service/hello-go-deploy-azure-app-service-code/* dist"
cp -r hello-go-deploy-azure-app-service/hello-go-deploy-azure-app-service-code/* dist
echo " "
...
#echo "Now we must move our code from the current directory ./hello-go-deploy-azure-app-service to" 
#echo "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-azure-app-service"
#mkdir -p src/github.com/JeffDeCola/
#cp -R ./hello-go-deploy-azure-app-service src/github.com/JeffDeCola/.
#echo " "

#echo "cd src/github.com/JeffDeCola/hello-go-deploy-azure-app-service/hello-go-deploy-azure-app-service-code"
#cd src/github.com/JeffDeCola/hello-go-deploy-azure-app-service/hello-go-deploy-azure-app-service-code
#echo " "
...
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-azure-app-service/hello-go-deploy-azure-app-service-code/bin/hello-go" .
#echo " "

#echo "cp the Dockerfile into /dist"
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-azure-app-service/hello-go-deploy-azure-app-service-code/build-push/Dockerfile" .
#echo " "
