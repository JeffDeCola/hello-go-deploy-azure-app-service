#!/bin/sh
# hello-go-deploy-azure-app-service readme-github-pages.sh
...
echo "The goal is to git clone /hello-go-deploy-azure-app-service to /hello-go-deploy-azure-app-service-updated"
...
echo "   /hello-go-deploy-azure-app-service-updated (created in task-build-push.yml task file)"
echo " "
...
echo "git clone hello-go-deploy-azure-app-service to hello-go-deploy-azure-app-service-updated"
git clone hello-go-deploy-azure-app-service hello-go-deploy-azure-app-service-updated
echo " "

echo "cd hello-go-deploy-azure-app-service-updated"
cd hello-go-deploy-azure-app-service-updated
echo " "
...
echo "    sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/hello-go-deploy-azure-app-service\/master\/svgs\//g' temp-README.md"
sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/hello-go-deploy-azure-app-service\/master\/svgs\//g' temp-README.md
echo " "
